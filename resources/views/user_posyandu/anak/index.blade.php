                    ...
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-12 col-md-auto text-md-left mb-3 mb-md-0">
                                <h2 class="card-title mb-0">Tabel Anak {{ $posyandu->nama }}</h2>
                            </div>
                                    ...
                                    @foreach ($anak as $key => $anak)
                                        <tr>
                                            ...
                                            <td>
                                                <span>
                                                    {{-- Edit --}}
                                                    <a href="{{ route('anaks.edit', $anak->id) }}"
                                                ...
                                                <form action="{{ route('anaks.destroy', $anak->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-danger"
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus anak ini?')"><i
                                                            class="fas fa-trash-alt"></i></button>
                                                </form>
                                                <span>
                                                    {{-- Edit --}}
                                                    <a href="{{ route('penimbangan.create', $anak->id) }}"
